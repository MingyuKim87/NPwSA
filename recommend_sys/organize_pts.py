...
if __name__ == "__main__":
    cwd = os.getcwd()
    # 복사한 후 저장 위치
    destination = os.path.join(cwd, 'test_save_models', 'fixed_200000_no_noise_no_userid_210406')
    
    # 복사할 파일 위치
    current_model_dir_path = "/home/mgyukim/workspaces/AI701/save_models/recommend_sys/fixed_200000_no_noise_no_userid_210407"
