...
if __name__ == "__main__":
    cwd = os.getcwd()
    # 복사한 후 저장 위치
    destination = os.path.join(cwd, 'test_save_models_2', 'fixed_200000_bald_210420')
    
    # 복사할 파일 위치
    current_model_dir_path = "/home/mgyukim/workspaces/AI701/save_models/celebA/fixed_200000_bald_210420"
